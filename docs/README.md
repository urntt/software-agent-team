...
| Understand and implement the next user-facing installation-to-delivery milestone | [`product-demo-slice.md`](product-demo-slice.md) |
...
- `product-demo-slice.md` specifies the approved next user-facing acceptance
  contract without replacing the decisions in `VISION.md`.
