...
through v11, lifecycle schema v5 from v1 through v4, and Planning schema v17 from
v2 through v16. Main-thread and repeated SIGINT tests must prove exact child
