...
DECISION_LIMIT_REGISTRY: tuple[DecisionLimitDefinition, ...] = (
    ...
    _definition(
        ...
        DecisionLimitCategory.DISCOVERED_CAPABILITY,
        DecisionValueReferenceKind.RUNTIME_DERIVED,
        "OpenClaw provider/model stream idle watchdog",
        owner="OpenClaw provider transport",
        rationale="Provider chunks renew liveness while total model work time remains unbounded by SAT.",
