...
DECISION_LIMIT_REGISTRY: tuple[DecisionLimitDefinition, ...] = (
    ...
    _definition(
        ...
        rationale="A finite sequence of attributable OpenClaw startup checkpoints separates a hung launch from provider generation without imposing a work-time budget.",
        visibility=DecisionLimitVisibility.ON_TRIGGER,
        configurability=DecisionLimitConfigurability.MAINTAINER_POLICY,
        consequence="No checkpoint progress enters a visible diagnostic window and eventually stops only the exact SAT-owned invocation.",
    ...
    _definition(
        ...
        owner="OpenClawSubprocessExecutor initialization observer",
        rationale="A visible final window permits a late but attributable startup checkpoint to recover before exact-process termination.",
        visibility=DecisionLimitVisibility.ON_TRIGGER,
        configurability=DecisionLimitConfigurability.MAINTAINER_POLICY,
        consequence="Checkpoint recovery resumes initialization; continued absence of progress becomes initialization_stalled.",
